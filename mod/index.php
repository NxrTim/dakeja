...
?>
    ...
    <form action="https://<?= $url; ?>/mod/new_round/index.php" method="post"><br>
        ...
        <input name="time" id="time" type="number" value="<?= $settings_time['value'] ?>" placeholder="60"><br>
        <span>Anzal Gewinner: </span>
        <input name="winners" id="winners" type="number" value="1" placeholder="1"><br><br>
        <input name="submiti" id="submiti" type="submit" value="Neue Versteigerung starten">
    </form>
    </body>
